...
class FaviconFetcher {
    ...
    function fetchUrl($site_url, $if_modified_since = 0) {
        ...
        $this->get_ico_url(); 
        $this->is_ico_exists();//echo $this->ico_exists;
        $this->get_ico_data(); //var_dump($this->ico_data);
    }
